...
public class FileLockTest {
    public static void main(String[] args) {
        String root = "G:\\BennyOfJava\\java-demo\\java-nio-demo\\src\\main\\java\\com.benny.jane\\filelock";
...
//            channel = new FileOutputStream("./lock2.txt", true).getChannel();
            RandomAccessFile raf = new RandomAccessFile(root + "\\lock2.txt", "rw");
