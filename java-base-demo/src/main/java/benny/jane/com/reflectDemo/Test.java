...
public class Test {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException {
        ...
        try {
            // forName 根据类的路径获取类对象
            child = Class.forName("com.benny.learning.reflectDemo.ReflectChild");
        ...
        // 获取对象的所有方法(不包含继承的父类)
        try {
            Class c = Class.forName("com.benny.learning.reflectDemo.ReflectChild");
        ...
        // 获取指定构造方法
        Class ch = Class.forName("com.benny.learning.reflectDemo.ReflectChild");
        try {
