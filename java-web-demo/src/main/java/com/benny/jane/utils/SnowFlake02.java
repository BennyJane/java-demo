...
import com.benny.jane.server.MachineIdService;
...
public class SnowFlake02 {

    private static final Logger LOGGER = LoggerFactory.getLogger(SnowFlake02.class);
    //最大的MachineId，1024个
    ...
    static {
        try {
            ...
            START_THE_WORLD_MILLIS = SimpleDateFormat.
                    getDateTimeInstance().parse("2018-09-13 00:00:00")
                    .getTime();
    ...
    public long genMessageId() {
        do {
            // TODO 获取当前时间戳，此时间戳是当前时间减去start the world的毫秒数
